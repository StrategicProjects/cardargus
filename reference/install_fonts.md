...
#> ✔ Jost (WOFF2)
#> ℹ Downloading "Jost"...
#> ✔ Downloading "Montserrat"... [312ms]
#> 
#> ℹ Downloading "Montserrat"...
#> ✔ Montserrat (WOFF2)
#> ℹ Downloading "Montserrat"...
#> ✔ Downloading "Roboto"... [104ms]
#> 
#> ℹ Downloading "Roboto"...
#> ✔ Roboto (WOFF2)
#> ℹ Downloading "Roboto"...
#> ✔ Downloading "Open Sans"... [105ms]
#> 
