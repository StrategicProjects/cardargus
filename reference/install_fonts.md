...
#> ✔ Jost (WOFF2)
#> ℹ Downloading "Jost"...
#> ✔ Downloading "Montserrat"... [212ms]
#> 
#> ℹ Downloading "Montserrat"...
#> ✔ Montserrat (WOFF2)
#> ℹ Downloading "Montserrat"...
#> ✔ Downloading "Roboto"... [106ms]
#> 
#> ℹ Downloading "Roboto"...
#> ✔ Roboto (WOFF2)
#> ℹ Downloading "Roboto"...
#> ✔ Downloading "Open Sans"... [109ms]
#> 
